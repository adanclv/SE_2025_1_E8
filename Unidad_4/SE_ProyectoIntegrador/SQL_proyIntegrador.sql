...
CREATE TABLE [dbo].[signal_type](
	[id_signal_type] [numeric](18, 0) IDENTITY(1,1) NOT NULL,
	[name] [nvarchar](100) NOT NULL,
PRIMARY KEY CLUSTERED 
(
	[id_signal_type] ASC
...
ALTER TABLE [dbo].[devices_info]  WITH CHECK ADD FOREIGN KEY([id_signal_type])
REFERENCES [dbo].[signal_type] ([id_signal_type])
GO

ALTER TABLE [dbo].[devices_info]  WITH CHECK ADD FOREIGN KEY([id_type])
REFERENCES [dbo].[device_type] ([id_type])
GO
...
--
INSERT INTO device_type (NAME) VALUES('SENSOR'), ('ACTUADOR');
INSERT INTO signal_type (NAME) VALUES('DIGITAL'), ('ANALOGICO');
...
CREATE TABLE toma_decisiones (
	...
	alpha NUMERIC(18, 0) NOT NULL,
	beta NUMERIC(18, 0) NOT NULL,
	decision NUMERIC(18, 0) NOT NULL, -- vo
	date_record DATETIME NOT NULL
);
...
--Paso 7
CREATE OR ALTER PROCEDURE [dbo].[SP_Insert_Decision]    
    @alpha as numeric(18, 0),
    @beta as numeric(18, 0),
